...
export const BUILDINGS: Building[] = [
  ...
  { id: "tavern", name: "The Ashen Cup", tagline: "Trials, allies & standing", description: "The gathering place. Take up the quests, bring friends to the fire, and earn Embers toward a reward revealed closer to launch. Then see where you stand on the leaderboard.", Panel: TavernPanel, mobileOrder: 6, kind: "panel", map: { x: 34.8, y: 58.4 }, scale: 13, art: "/world/buildings/tavern.webp", wide: true },
  { id: "bonfire", name: "The Bonfire", tagline: "Live burn counter", description: "The heart of the kingdom. Every $PYRE fed to the fire feeds this flame. Watch the global burn counter climb in real time.", Panel: BonfirePanel, mobileOrder: 1, kind: "bonfire", map: { x: 49.6, y: 54.6 }, scale: 13, art: "/world/buildings/bonfire.webp" },
  { id: "vault", name: "The Amber Vault", tagline: "Your position & Acolyte", description: "Your personal hold. Your Pyre Acolyte, your balances, your yield, your standing in the fire. Everything about you in one place.", Panel: AmberVaultPanel, mobileOrder: 2, kind: "panel", map: { x: 63.9, y: 60.4 }, scale: 13, art: "/world/buildings/vault.webp" },
  { id: "market", name: "The Black Market", tagline: "Buy & sell Acolytes", description: "The bazaar of Pyre Acolytes. Browse and acquire the Acolytes other wallets have forged, wrapped in PYRE's own window.", Panel: BlackMarketPanel, mobileOrder: 8, kind: "panel", map: { x: 39.3, y: 67.7 }, scale: 13, art: "/world/buildings/market.webp" },
  { id: "exchange", name: "The Grand Exchange", tagline: "Buy & sell $PYRE", description: "The trading floor. Swap ETH and $PYRE with the fees shown to you honestly: sell-side burned, buy-side to the pool.", Panel: GrandExchangePanel, mobileOrder: 7, kind: "panel", map: { x: 58.8, y: 67.6 }, scale: 13, art: "/world/buildings/exchange.webp" },
  { id: "gate", name: "The Gate", tagline: "Connect wallet", description: "The threshold of the kingdom. Light the lantern to wake the fires and step inside.", Panel: GatePanel, mobileOrder: null, kind: "gate", map: { x: 49.2, y: 73.1 }, scale: 13, art: "/world/buildings/gate.webp" },
];
