...
export const BUILDINGS: Building[] = [
  ...
  { id: "tavern", name: "The Ashen Cup", tagline: "Quests, invites & leaderboard", description: "Complete quests and invite friends to earn Embers (your points) toward a reward revealed closer to launch, then see where you rank on the leaderboard.", Panel: TavernPanel, mobileOrder: 6, kind: "panel", map: { x: 34.8, y: 58.4 }, scale: 13, art: "/world/buildings/tavern.webp", wide: true },
  ...
  { id: "vault", name: "The Amber Vault", tagline: "Your position & Acolyte", description: "Your personal dashboard: your Acolyte NFT, your balances, your yield, and your rank. Everything about your account in one place.", Panel: AmberVaultPanel, mobileOrder: 2, kind: "panel", map: { x: 63.9, y: 60.4 }, scale: 13, art: "/world/buildings/vault.webp" },
  ...
  { id: "gate", name: "The Gate", tagline: "Connect wallet", description: "The entrance. Connect your wallet, or continue as a guest, to step inside.", Panel: GatePanel, mobileOrder: null, kind: "gate", map: { x: 49.2, y: 73.1 }, scale: 13, art: "/world/buildings/gate.webp" },
];
