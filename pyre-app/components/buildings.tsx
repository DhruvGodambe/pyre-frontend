...
export const BUILDINGS: Building[] = [
  ...
  { id: "immolated", name: "Hall of the Immolated", tagline: "The highest prestige", description: "For top holders only. Reach the Pyre tier, then take the Ascend rite here, burning 100K $PYRE (or 100K $PYRE with the equivalent $ETH on the LP path), to become Immolated: the rarest Acolyte and the highest prestige in the kingdom.", Panel: ImmolatedPanel, mobileOrder: 5, kind: "panel", map: { x: 49.7, y: 41.9 }, scale: 20, art: "/world/buildings/immolated.webp", interior: "/world/interiors/immolated.webp", exterior: "/world/exteriors/immolated.webp", icon: "/world/icons/immolated.webp", sound: "/world/audio/immolated.mp3", wide: true },
  ...
  { id: "observatory", name: "The Observatory", tagline: "Live protocol stats", description: "The watchtower. Live readings of the whole protocol: supply, decay, burns, staking and yield. No wallet needed.", Panel: ObservatoryPanel, mobileOrder: 4, kind: "panel", map: { x: 60.1, y: 46.9 }, scale: 15, art: "/world/buildings/observatory.webp", interior: "/world/interiors/observatory.webp", exterior: "/world/exteriors/observatory.webp", icon: "/world/icons/observatory.webp", sound: "/world/audio/observatory.mp3", wide: true },
  ...
  { id: "bonfire", name: "The Bonfire", tagline: "Live burn counter", description: "The center of PYRE. Every $PYRE anyone burns is counted here. Watch the total climb in real time.", Panel: BonfirePanel, mobileOrder: 1, kind: "bonfire", map: { x: 49.6, y: 54.6 }, scale: 13, art: "/world/buildings/bonfire.webp", interior: "/world/interiors/bonfire.webp", icon: "/world/icons/bonfire.webp", sound: "/world/audio/fire.mp3" },
  { id: "vault", name: "The Amber Vault", tagline: "Your position & Acolyte", description: "Your personal dashboard: your Acolyte NFT, your balances, your yield, and your rank. Everything about your account in one place.", Panel: AmberVaultPanel, mobileOrder: 2, kind: "panel", map: { x: 63.9, y: 60.4 }, scale: 13, art: "/world/buildings/vault.webp", interior: "/world/interiors/vault.webp", exterior: "/world/exteriors/vault.webp", icon: "/world/icons/vault.webp", sound: "/world/audio/vault.mp3", wide: true },
  { id: "market", name: "The Black Market", tagline: "Buy & sell Acolytes", description: "The bazaar of Pyre Acolytes. Browse and acquire the Acolytes other wallets have forged, wrapped in PYRE's own window.", Panel: BlackMarketPanel, mobileOrder: 8, kind: "panel", map: { x: 39.3, y: 67.7 }, scale: 13, art: "/world/buildings/market.webp", interior: "/world/interiors/market.webp", exterior: "/world/exteriors/market.webp", icon: "/world/icons/market.webp", sound: "/world/audio/market.mp3", wide: true },
  { id: "exchange", name: "The Grand Exchange", tagline: "Buy & sell $PYRE", description: "The trading floor. Swap $ETH and $PYRE, and keep an eye on your swap history, all in one place.", Panel: GrandExchangePanel, mobileOrder: 7, kind: "panel", map: { x: 58.8, y: 67.6 }, scale: 13, art: "/world/buildings/exchange.webp", interior: "/world/interiors/exchange.webp", exterior: "/world/exteriors/exchange.webp", icon: "/world/icons/exchange.webp", sound: "/world/audio/exchange.mp3" },
