...
export const BUILDINGS: Building[] = [
  ...
  { id: "tavern", name: "The Ashen Cup", tagline: "Quests & leaderboard", description: "The gathering place. Take up the quests, bring friends to the fire, and earn Embers toward a reward revealed closer to launch. Then see where you stand on the leaderboard.", Panel: TavernPanel, mobileOrder: 6, kind: "panel", map: { x: 34.8, y: 58.4 }, scale: 13, art: "/world/buildings/tavern.webp" },
